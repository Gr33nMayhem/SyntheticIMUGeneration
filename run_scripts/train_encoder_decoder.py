...
torch.save(model.state_dict(),
           f'../data/results/encoder_decoder_model_{reference_point}_{window_size}_{step_size}_{imu_position}_{learning_rate}_{batch_size}_{num_epochs}_{loss_function}.pt')
